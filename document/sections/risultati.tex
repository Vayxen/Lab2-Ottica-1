...
\begin{figure}[ht!]
    ...
    \caption{Intensità luminosa $I$ in funzione della posizione $y$ del sensore (in metri) per la fenditura a $\qty{0.04}{\mm}$. In figura sono segnati i minimi ricavati graficamente con i relativi errori.} % todo: aggiungere qualcosa in più alla descrizione
...
% Facendo una media pesata dei valori ottenuti si ha $a = \qty{0.0424+-0.0012}{\mm}$.
